  ...
  describe "GET 'index'" do
    ...
    describe "for signed in users" do
      ...
      before(:each) do
        ...
        second = Factory(:user, :email => "user@another.com")
        third = Factory(:user, :email => "user@yetanother.com")
      ...
      it "should not display user delete links" do
        get :index
        @users[0..2].each do |user|
    ...
    describe "for signed in admin users" do
      ...
      it "should display delete links for users" do
        get :index
        @users[0..2].each do |user|
...
### GET 'new'
  ...
  describe "GET 'new'" do
    ...
    describe "for signed in users" do
      ...
      it "should deny access to 'new' action and redirect to root" do
        @user = Factory(:user)
        test_sign_in(@user)
        get :new
...
### POST 'create'
  ...
  describe "POST 'create'" do
    ...
    describe "for signed in users" do
      ...
      it "should deny access to the 'create' action and redirect to root" do
        @user = Factory(:user)
        test_sign_in(@user)
        post :create
        response.should redirect_to(root_path)
...
### PUT 'update'
  ...
  describe "PUT 'update'" do
    ...
    describe "failure" do
      ...
      before(:each) do
        @attr = { :name => "", :email => "", :password => "", :password_cofirmation => "" }
      end
    ...
    describe "success" do
      ...
      before(:each) do
        @attr = { :name => "Edited Name", :email => "edited@email.com",
        		  :password => "edited", :password_confirmation => "edited" }
      end
      ...
      it "should redirect to the user show page" do
        put :update, :id => @user, :user => @attr
        response.should redirect_to(user_path(@user))  # assigns(@user) ?
      end
  ...
  describe "DELETE 'destroy'" do
    ...
    describe "for signed in admin user" do
      ...
      it "should not allow them to delete themselves" do
        ...
        flash[:failure].should =~ /cannot destroy/i
      end
...
### USER FOLLOWERS/FOLLOWING PAGES

  describe "follow pages" do
  
    describe "when not signed in" do
    
      it "should protect the following page" do
        get :following, :id => 1
        response.should redirect_to(signin_path)
      end
      
      it "should protect the followers page" do
        get :followers, :id => 1
        response.should redirect_to(signin_path)
      end
